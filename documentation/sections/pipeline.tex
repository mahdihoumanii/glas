...
The results of the contraction of the complex conjugate of tree-level amplitude $\mathcal{M}_0^*$ and one loop-amplitude $\mathcal{M}_1$ with diagrams $d_i^*$ and $d_1$ is represented via the following equation: 
\begin{equation}
   \sum_{s, c} \mathcal{M}_0^* \mathcal{M}_1 = \sum_{i, j} \sum_{s, c} d_{i}^* d_{j}
\end{equation}
and is saved in the directory \texttt{form(Mathematica)/Files/M0M1}
%=============================================================================
