...
\begin{align}
    2\,\Re\langle \mathcal{M}^{(0)}_{n+1} | \mathbf{I} | \mathcal{M}^{(0)}_{n+1} \rangle &= \frac{\alpha_s}{4\pi} \frac{1}{\epsilon} \Bigg[ \left( -\frac{2}{\epsilon} \sum_{i_0} C_{i_0} + \sum_i \gamma_0^i \right) |\mathcal{M}^{(0)}_{n+1}|^2 \nonumber \\
