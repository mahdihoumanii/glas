...
all = Join[First/@usints,GetAllInts[FileNames["ibps/ints_top6_*.mx"]], First/@exints];
target = Get["target"];
If[target === 0,
...
Put[{nonmis,mis,MappedSectors[top6],UniqueSectors[top6],ConstantArray[{},Length[nonmis]]}, FileNameJoin@{resdir, "datainfo"}];
Abort[]];
...
Put[{nonmis,mis,MappedSectors[top6],UniqueSectors[top6],sparseinfo}, FileNameJoin@{resdir, "datainfo"}];
