...
NewBasis[top4,Propagators,Internal, External, MomentumConservation, Replacements,"ExtraIntDeriv"->{{{0}, {0}, {0}, {0}}}];
AnalyzeSectors[top4,{1, 1, 1, 1},"CutDs"->{0, 0, 0, 0},"Prescription"->{1, 1, 1, 1},"CloseSyms"->False,"ExtSyms"->True];
