...
all = Join[First/@usints,GetAllInts[FileNames["ibps/ints_top5_*.mx"]], First/@exints];
target = Get["target"];
If[target === 0,
...
Put[{nonmis,mis,MappedSectors[top5],UniqueSectors[top5],ConstantArray[{},Length[nonmis]]}, FileNameJoin@{resdir, "datainfo"}];
Abort[]];
...
Put[{nonmis,mis,MappedSectors[top5],UniqueSectors[top5],sparseinfo}, FileNameJoin@{resdir, "datainfo"}];
