...
Put[ZeroSectors[top2],"results/zerosectors"];
If[NonZeroSectors[top2]==={}, Print["this family is trivial."];Quit[]];
...
learn={4 -> {0, 2}, 3 -> {0, 2}, 2 -> {0, 2}, 1 -> {0, 2}, _ -> {0, 2}};
...
rawmasters=<|BL[top2, {1, 1, 1, 1}] -> {BL[top2, {1, 1, 1, 1}]}, BL[top2, {0, 1, 1, 1}] -> {BL[top2, {0, 1, 1, 1}]}, BL[top2, {1, 1, 0, 1}] -> {BL[top2, {1, 1, 0, 1}]}, BL[top2, {0, 1, 1, 0}] -> {BL[top2, {0, 1, 1, 0}]}, BL[top2, {1, 0, 0, 1}] -> {BL[top2, {1, 0, 0, 1}]}, BL[top2, {0, 0, 0, 1}] -> {BL[top2, {0, 0, 0, 1}]}, BL[top2, {0, 1, 0, 0}] -> {BL[top2, {0, 1, 0, 0}]}|>;
GetSeeds["SubSym"][sector_]:=Lookup[rawmasters,sector,{}];
GetSeeds["ExtMap"][sector_]:=GenSeeds[sector,{0,maxdots+1},0,rank];
FastGenIds[top2,GetSeeds,"Directory"->"ibps","LaunchKernels"->4,"GetSectors"->GetSectors];
];
...
Export["ibps/ids_top2_exints.mx",(-#[[1]]+#[[2]])&/@exints,"MX"];
Export["ibps/ints_top2_exints.mx",IntegralsIn[exints],"MX"];
usints = {};
Export["ibps/usints_def.m",usints];
Export["ibps/ids_top2_usints.mx",(-#[[1]]+#[[2]])&/@usints,"MX"];
Export["ibps/ints_top2_usints.mx",IntegralsIn[usints],"MX"];


If[!({s12, s13, ep}==={}),SerializeFastIds[FileNames["ibps/ids_top2_*.mx"], {msq -> 1}, {s12, s13, ep}, "UserDefinedInts"->(First/@usints),"ExtraInts"->(First/@exints)]];
];
