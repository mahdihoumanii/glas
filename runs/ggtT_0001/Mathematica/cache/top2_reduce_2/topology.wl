...
Propagators = {(l - p3)^2, l^2 - msq, (l + p2 - p3)^2, -msq + (l - p1)^2}/. MomentumConservation//Expand;
NewBasis[top2,Propagators,Internal, External, MomentumConservation, Replacements,"ExtraIntDeriv"->{{{0}, {0}, {0}, {0}}}];
AnalyzeSectors[top2,{1, 1, 1, 1},"CutDs"->{0, 0, 0, 0},"Prescription"->{1, 1, 1, 1},"CloseSyms"->False,"ExtSyms"->True];
