...
all = Join[First/@usints,GetAllInts[FileNames["ibps/ints_top2_*.mx"]], First/@exints];
target = Get["target"];
If[target === 0,
...
Put[{nonmis,mis,MappedSectors[top2],UniqueSectors[top2],ConstantArray[{},Length[nonmis]]}, FileNameJoin@{resdir, "datainfo"}];
Abort[]];
...
Put[{nonmis,mis,MappedSectors[top2],UniqueSectors[top2],sparseinfo}, FileNameJoin@{resdir, "datainfo"}];
