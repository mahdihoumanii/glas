...
all = Join[First/@usints,GetAllInts[FileNames["ibps/ints_top1_*.mx"]], First/@exints];
target = Get["target"];
If[target === 0,
...
Put[{nonmis,mis,MappedSectors[top1],UniqueSectors[top1],ConstantArray[{},Length[nonmis]]}, FileNameJoin@{resdir, "datainfo"}];
Abort[]];
...
Put[{nonmis,mis,MappedSectors[top1],UniqueSectors[top1],sparseinfo}, FileNameJoin@{resdir, "datainfo"}];
