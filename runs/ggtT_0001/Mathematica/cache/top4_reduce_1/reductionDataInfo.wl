...
Put[{nonmis,mis,MappedSectors[top4],UniqueSectors[top4],ConstantArray[{},Length[nonmis]]}, FileNameJoin@{resdir, "datainfo"}];
Abort[]];
...
Put[{nonmis,mis,MappedSectors[top4],UniqueSectors[top4],sparseinfo}, FileNameJoin@{resdir, "datainfo"}];
