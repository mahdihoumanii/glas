...
all = Join[First/@usints,GetAllInts[FileNames["ibps/ints_top7_*.mx"]], First/@exints];
target = Get["target"];
If[target === 0,
...
Put[{nonmis,mis,MappedSectors[top7],UniqueSectors[top7],ConstantArray[{},Length[nonmis]]}, FileNameJoin@{resdir, "datainfo"}];
Abort[]];
...
Put[{nonmis,mis,MappedSectors[top7],UniqueSectors[top7],sparseinfo}, FileNameJoin@{resdir, "datainfo"}];
