...
Propagators = {l^2, (l + p2)^2, (l - p1)^2, -msq + (l + p2 - p3)^2}/. MomentumConservation//Expand;
NewBasis[top5,Propagators,Internal, External, MomentumConservation, Replacements,"ExtraIntDeriv"->{{{0}, {0}, {0}, {0}}}];
AnalyzeSectors[top5,{1, 1, 1, 1},"CutDs"->{0, 0, 0, 0},"Prescription"->{1, 1, 1, 1},"CloseSyms"->False,"ExtSyms"->True];
