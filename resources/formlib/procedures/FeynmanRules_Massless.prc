...
#do i = 1, 3
id once vx(g(s1?,p1?),g(s2?,p2?),g(s3?,p3?),g(s4?, p4?))= -i_* gs^2 *( 
                                                        fsub(s1,s2,c`i')*fsub(s3, s4, c`i')*(fgv(s1, s3,s2, s4)- fgv(s1, s4, s2, s3)) + 
                                                        fsub(s1, s3, c`i')*fsub(s2, s4, c`i')*(fgv(s1, s2, s3, s4) - fgv(s1, s4,s2, s3))+ 
                                                        fsub(s1, s4, c`i')*fsub(s2,s3,c`i')*(fgv(s1, s2, s3, s4) - fgv(s1, s3, s2, s4))  
                                                        );
#enddo 
